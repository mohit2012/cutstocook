    ...
    <div class="container">
      <div class="section">
        <div class="column is-6 is-offset-3">
          <center>
            <h1 class="title" style="padding-top: 20px">Foodeli Installation</h1><br>
          </center>
          <div class="box">
            <?php
switch ($step) {
...
break;
  ...
  <div class="content has-text-centered">
    <p>© <?php echo date('Y'); ?> Copyright foodeli by <a  target="_blank"  href="http://ondemandscript.in/">OnDemand</a></p><br>
  </div>
</body>

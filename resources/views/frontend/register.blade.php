        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{url('image/Icon/Logo.png')}}" alt="">
                </a>
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="">
                                <img src="image/Icon/fast-food.png" alt="">
                                <b class="t1">food</b>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="">
                                <img src="image/Icon/Outline.png" alt="">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <div class="card rounded-lg">
                                <div class="row">
                                    <div class="col-md-4 pl-4 pt-3 float-left">Register</div>
                                    <div class="col-md-4 pl-4 pt-3"></div>
                                    <div class="col-md-4 pl-5 pt-3 float-right"><img
                                            src="{{ url('image/cross icon.png') }}" alt=""></div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col">
                                                <input id="name" type="text"
                                                    ...
                                                    name="name" required placeholder="Enter user name" autofocus>

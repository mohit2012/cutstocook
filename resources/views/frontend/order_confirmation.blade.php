...
<div class="container groceryOrderContainer">
    ...
    <input type="hidden" name="" id="hidden_coupen_use_for" value="{{0}}">
    <input type="hidden" name="" id="hidden_session" value="{{ 'food' }}">
    ...
    <input type="hidden" name="" id="hidden_rastaurant_charge" value="{{ $shop->rastaurant_charge }}">
    @php
    $price = 0;
    @endphp
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <p class="total_amount float-right">
                {{ $currency }}{{$price + $shop->delivery_charge + $shop->rastaurant_charge}}
            </p>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="col-md-12 col-12 col-sm-12">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-6 col-md-8 col-sm-6">
                                <h5 class="text-left"> {{  App\Item::find($item['id'])->name }}</h5>
                            </div>
                            <div class="col-6 col-md-4 col-sm-6">
                                ...
                                <span class="qty">
                                    <button class="{{'minus'.$item['id']}}"
                                        onclick="update_cart({{$item['id']}},'item','minus')">-</button>
                            ...
                            @endif
                            @endif @if ($item['type'] == 'combo')
                            @if(isset($item['combo_id']))
                            <div class="col-6 col-md-8 col-sm-6">
                                <h5 class="text-left">{{ App\Package::find($item['combo_id'])->name }} </h5>
                            </div>
                            <div class="col-6 col-md-4 col-sm-6">
                                @php
                                $original_price_combo = App\Package::find($item['combo_id'])->package_price;
                                @endphp
                                <input type="hidden" id="{{'original_price' . $item['combo_id']}}" value="{{ $original_price_combo }}">
                                {{ $currency }}<input type="text" class="price" id="{{'price' . $item['combo_id']}}"
                                    value="{{ $item['price'] }}" class="form-control" readonly>
                                <span class="qty">
                                    <button class="{{'minus'.$item['combo_id']}}"
                                        onclick="update_cart({{$item['combo_id']}},'combo','minus')"
                                        {{ $item['combo_id'] == '1' ? 'disabled' : '' }}>-</button>
                                    <input type="text" value="{{$item['qty']}}" id="{{'qty' . $item['combo_id']}}"
                    ...
                    <div class="apply_coupen">
                        <div class="form-inline">
                            <div class="col-3 col-md-3 col-sm-12 pt-3">
                                ...
                                <p class="float-left">Apply Coupon</p>
                            </div>
                            <div class="col-6 col-md-6 col-sm-12">
                                <input type="text" class="form-control float-left coupen_textbox"
                                    placeholder="add code here.." id="coupen" onchange="applycoupen('Food');"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-6 user_select_address">
                                ...
                                <div class="text-secondary user_address_display">
                                    ...
                                    <img src="{{ url('frontend/image/icon/Icon awesome-map-marker-alt.png') }}" class="ml-3"
                                        alt="">&nbsp;
                            ...
                            <div class="col-md-6 col-sm-6 col-6">
                                <a href="" class="text-green float-right mr-2" data-toggle="modal"
                                    data-target="#exampleModalCenter">Address</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-12 h-50 w-100 col-lg-4">
            <div class="bg-light">
                ...
                <table class="table table-borderless text-left">
                    ...
                    <tr>
                        ...
                        <td class="float-right restaurent_charge">{{ $currency }}{{ $shop->rastaurant_charge }}</td>
                    </tr>
                    <tr>
                        <td>Delivery charge</td>
                        <td class="float-right delivery_charge">{{ $currency }}{{ $shop->delivery_charge }}</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <hr>
                    ...
                    <tr>
                        <td>To pay</td>
                        <td id="to_pay" class="float-right">
                            {{ $currency }}{{$price + $shop->rastaurant_charge + $shop->delivery_charge }}</td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div id="saved"></div>
                    ...
                    <tr>
                        ...
                        @endphp
                        <td>
                            @if($sell_product == 0 || $sell_product == 1)
                            <input type="radio" name="delivery_type" id="delivery_type_shop" value="delivery"
                                checked>&nbsp;
                            <label for="delivery_type_shop"> Delivery</label></td>
                        @endif
                        <td>
                            <input type="radio" name="delivery_type" id="delivery_type_home" value="pick up">&nbsp;
                            <label for="delivery_type_home"> Pick Up</label></td>
                    </tr>
                    <tr>
                        <td class="text-center" colspan="2">
                            <button class="btn btn-lg green text-white" id="select_payment_method">Select payment
                                method</button>
                        </td>
                    </tr>
                </table>
                ...
                <div class="row pt-5 payment_method_row">
                    <div class="col-xs-12 col-md-12 col-lg-12 col-sm-12 pt-5">
                        <div class="t1 bg-light pt-5">
                            ...
                            <input type="hidden" name="total_payment" id="total_payment" value="{{ $price + $shop->delivery_charge + $shop->rastaurant_charge  + 0 }}">
                    ...
                    <div class="col-xs-12 col-md-12 col-sm-12">
                        <div class="t1 bg-light online_payment">
                            ...
                            <div class="text-center payment_type">
                                ...
                                ?>
                                <input type="hidden" id="hidden_cuurency_type" value="{{ $c }}">
                                ...
                                {{-- @if ($payment_setting->paytm == 1) --}}
                                    <label class="radio">
                                        <input type="radio" value="PAYTM" name="payment">
                                        <img src={{ url('frontend/image/icon/paystack_logo.png')}} width="75px" height="20px" alt="">
                                    </label>
                                {{-- @endif --}}
                            </div>
                            ...
                            <div class="payment_gateway">
                                <div class="show {{ $c == 'INR' ? 'hide-div' : '' }}" id="paypal">
                                    <div class="card card-body paypal_payment">
                                    </div>
                                </div>
                                <div class="{{ $c != 'INR' ? 'hide-div' : '' }}" id="razorpay">
                                    <div class="card card-body">
                                        <form id="rzp-footer-form" action="{{url('razor')}}" method="POST">
                                            ...
                                            <div class="pay">
                                                <button class="razorpay-payment-button btn bg-blue text-white btn filled small" id="paybtn" type="button">Pay with Razorpay</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-body">
                                        <form role="form" action="{{ url('frontendStripePayment') }}" method="post"
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row" style="margin-top:-2px;">
                                                            <div class="col-lg-6 pr-0">
                                                                <input type="text"
                                                                    class="expiry-date required form-control"
                                                            ...
                                                            <div class="col-lg-6 pl-0">
                                                                <input type="text"
                                                                    class="card-cvc required form-control"
                                                                    title="please input only number." pattern="[0-9]{3}"
                                                                    name="card-cvc" placeholder="CVC" title="CVC"
                                                                    required />
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <span class="stripe-error hide" style="color: red"></span>
                                                </div>
                                                <div class="col-12">
                                ...
                                <div class="hide-div" id="paytm">
                                    <div class="card card-body">
                                        <input type="submit" onclick="paytm()" class="btn bg-blue text-white" value="payment with Paytm" />
                                    </div>
                                </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="text" id="soc_name" class="form-control mt-2"
                    ...
                    <div class="col-md-6 display_user_address">
                        ...
                        <input type="radio" id="user_select_address" value="{{ $item->id }}" name="user_select_address"
                            {{ $auth_user_id == $item->id ? 'checked' : '' }}>
                        <label for="user_select_address"><img src="{{ url('image/icon/Icon awesome-map-marker-alt.png') }}" alt="">{{ $item->soc_name }},{{ $item->street }},{{ $item->city }},{{ $item->zipcode }}</label>
                        <hr>
                        @endforeach
                    </div>
                </div>

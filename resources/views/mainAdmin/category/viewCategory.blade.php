                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a href="{{url('mainAdmin/AdminCategory/create')}}" class="btn btn-sm btn-primary">{{ __('Add New Category') }}</a>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td >                            
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="{{url('mainAdmin/AdminCategory/'.$category->id.'/edit')}}">{{ __('Edit') }}</a>
                                                            <a class="dropdown-item" onclick="deleteData('mainAdmin/AdminCategory','{{$category->id}}');" href="#">{{ __('Delete') }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>

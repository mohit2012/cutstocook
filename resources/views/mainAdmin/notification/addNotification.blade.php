...
@section('content')
    @include('admin.layout.topHeader', [
        ...
        'url' => 'mainAdmin/NotificationTemplate' ,
        'class' => 'col-lg-7'
    ]) 
                            ...
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-right">
                                        <a href="{{ url('mainAdmin/NotificationTemplate') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{url('mainAdmin/NotificationTemplate')}}" id="add-template-form" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf

                    ...
                    <div class="card bg-secondary shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    {{-- <a href="{{url('mainAdmin/NotificationTemplate/create')}}" class="btn btn-sm btn-primary">{{ __('Add New Template') }}</a> --}}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-7">
                                        <form method="post" action="{{url('mainAdmin/NotificationTemplate/'.$template->id)}}" id="edit-template-form" autocomplete="off" enctype="multipart/form-data" >
                                            @csrf
                                            @method('put')
                                ...
                                <div class="col-2">
                                    ...
                                    <div class="mail-placeholder">  
                                        ...
                                        <button type="button" class="btn btn-sm" data-toggle="tooltip" data-placement="top" title="Customer name">@{{customer_name}}</button>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{url('mainAdmin/sendTestMail')}}">
                        @csrf                        

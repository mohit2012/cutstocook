                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    {{-- <a href="{{url('AdminShop/create')}}" class="btn btn-sm btn-primary">{{ __('Add New Shop') }}</a> --}}
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($shops as $shop)
                                            ...
                                            <tr>
                                                ...
                                                <td>                            
                                                    {{-- <a href="{{url('AdminShop/'.$shop->id.'/edit')}}" class="table-action" data-toggle="tooltip" data-original-title="Edit product">
                                                        <i class="fas fa-user-edit"></i>
                                                    </a>
                                                    <a href="#!" onclick="deleteData('AdminShop','{{$shop->id}}');" class="table-action table-action-delete" data-toggle="tooltip" data-original-title="Delete product">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="{{url('mainAdmin/AdminShop/'.$shop->name)}}">{{ __('View') }}</a>
                                                            {{-- <a class="dropdown-item" href="{{url('AdminShop/'.$shop->id.'/edit')}}">{{ __('Edit') }}</a> --}}
                                                            <a class="dropdown-item" onclick="deleteData('mainAdmin/AdminShop','{{$shop->id}}');" href="#">{{ __('Delete') }}</a>
                                                        </div>
                                                    </div>

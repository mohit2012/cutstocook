            ...
            <div class="row">
                    <div class="col-xl-12 order-xl-1">
                        <div class="card form-card bg-secondary shadow">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{url('mainAdmin/AdminShop')}}" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group{{ $errors->has('rastaurant_charge') ? ' has-danger' : '' }}">
                                                    ...
                                                    <input type="number" name="rastaurant_charge" id="input-rastaurant_charge" class="form-control form-control-alternative{{ $errors->has('rastaurant_charge') ? ' is-invalid' : '' }}" placeholder="{{ __('Shop Charge') }}" value="{{ old('rastaurant_charge') }}" required >
                                            ...
                                            <div class="col-4">
                                                <div class="form-group{{ $errors->has('delivery_charge') ? ' has-danger' : '' }}">
                                                    ...
                                                    <input type="number" name="delivery_charge" id="input-delivery_charge" class="form-control form-control-alternative{{ $errors->has('delivery_charge') ? ' is-invalid' : '' }}" placeholder="{{ __('Delivery Charge') }}" value="{{ old('delivery_charge') }}" required >
                                            ...
                                            <div class="col-4">
                                                <div class="form-group{{ $errors->has('cancle_charge') ? ' has-danger' : '' }}">
                                                    ...
                                                    <input type="number" name="cancle_charge" id="input-cancle_charge" class="form-control form-control-alternative{{ $errors->has('cancle_charge') ? ' is-invalid' : '' }}" placeholder="{{ __('Cancle Charge') }}" value="{{ old('cancle_charge') }}" required >

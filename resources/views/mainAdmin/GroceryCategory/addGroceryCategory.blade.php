                            ...
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-right">
                                        <a href="{{ url('mainAdmin/GroceryCategory') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                        <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal">{{ __('Import Category') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{url('mainAdmin/GroceryCategory')}}" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ url('mainAdmin/GroceryCategory/importExcel') }}" method="post" enctype="multipart/form-data">
                    @csrf

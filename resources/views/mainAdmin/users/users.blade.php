                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a href="{{url('mainAdmin/Customer/create')}}" class="btn btn-sm btn-primary">{{ __('Add New user') }}</a>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td>
                                                     <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="{{url('mainAdmin/Customer/gallery/'.$user->id)}}">{{ __('View Gallery') }}</a>
                                                            <a class="dropdown-item" href="{{url('mainAdmin/Customer/'.$user->id.'/edit')}}">{{ __('Edit') }}</a>

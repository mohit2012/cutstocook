                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a href="{{url('mainAdmin/Location/create')}}" class="btn btn-sm btn-primary">{{ __('Add New Location') }}</a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge badge-dot mr-4">
                                                        ...
                                                        <span class="status">{{$location->status==0?'Active': 'Inactive'}}</span>
                                                    </span>
                                                </td>
                                                <td>  
                                                ...
                                                <td>                            
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="{{url('mainAdmin/Location/'.$location->id.'/edit')}}">{{ __('Edit') }}</a>
                                                            <a class="dropdown-item" onclick="deleteData('mainAdmin/Location','{{$location->id}}');" href="#">{{ __('Delete') }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>

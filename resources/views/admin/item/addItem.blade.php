            ...
            <div class="row">
                    <div class="col-xl-12 order-xl-1">
                        <div class="card form-card bg-secondary shadow">
                            ...
                            <div class="card-body">
                                <form method="post" action="{{url('owner/Item')}}" autocomplete="off"   >
                                    @csrf
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="form-group row{{ $errors->has('isVeg') ? ' has-danger' : '' }}">                                            
                                            ...
                                            <div class="col-4 row">
                                                ...
                                                <div class="col-6">
                                                    <label class="custom-toggle">
                                                        <input type="radio" value="1" id="veg" name="isVeg" class="{{ $errors->has('isVeg') ? ' is-invalid' : '' }}"> 
                                            ...
                                            <div class="col-4 row">
                                                ...
                                                <div class="col-6">
                                                    <label class="custom-toggle">
                                                        <input type="radio" value="0" id="nonVeg" name="isVeg" class="{{ $errors->has('isVeg') ? ' is-invalid' : '' }}">
                                                        <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                    </label>
                                                </div>
                                            </div>

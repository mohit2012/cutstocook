                            ...
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-right">
                                        <a href="{{ url('owner/Item') }}" class="btn btn-sm btn-primary">{{   __('Back to list') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{url('owner/Item/'.$data->id)}}" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group{{ $errors->has('shop_id') ? ' has-danger' : '' }}">
                                                    <label class="form-control-label" for="item_shop">{{ __("Item's Shop") }}</label>
                                                    <select name="shop_id" id="item_shop"class="form-control form-control-alternative{{ $errors->has('shop_id') ? ' is-invalid' : '' }}"required>
                                        ...
                                        <?php $veg= \App\Shop::find($data->shop_id); ?>
                                        <div class="form-group row{{ $errors->has('isVeg') ? ' has-danger' : '' }}">                                                                                        
                                            <div class="col-4 row">
                                                <div class="col-6"> <label class="form-control-label">{{ __('Veg') }}</label></div>
                                                <div class="col-6">
                                                    <label class="custom-toggle">
                                                        <input type="radio" value="1" id="veg" name="isVeg" {{ $data->isVeg==1 ? 'Checked' : '' }} class="{{ $errors->has('isVeg') ? ' is-invalid' : '' }}"> 
                                            ...
                                            <div class="col-4 row">
                                                ...
                                                <div class="col-6">
                                                    <label class="custom-toggle">
                                                        <input type="radio" value="0" id="nonVeg" {{$veg->veg==1?'disabled':''}} name="isVeg" {{ $data->isVeg==0 ? 'Checked' : '' }} class="{{ $errors->has('isVeg') ? ' is-invalid' : '' }}">
                                                        <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                    </label>
                                                </div>
                                            </div>

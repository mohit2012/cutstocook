        ...
        <div class="row">
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Shop Owner - Creative Team '.\App\CompanySetting::find(1)->name) }}
                            </div>
            ...
            <div class="col-xl-8 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('owner/editOwnerProfile')}}" autocomplete="off"  enctype="multipart/form-data">
                            @csrf
                        ...
                        <hr class="my-4"/>
                        <form method="post" action="{{url('owner/changeOwnerPassword')}}" autocomplete="off">
                            @csrf

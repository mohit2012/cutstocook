            ...
            <div class="row">
                    <div class="col-xl-12 order-xl-1">
                        <div class="card form-card bg-secondary shadow">
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-right">
                                        ...
                                        <a href="{{ url('owner/Coupon') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                        @elseif($data->use_for =="Grocery")
                                        <a href="{{ url('owner/GroceryCoupon') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                                        @endif
                            ...
                            <div class="card-body">
                                @if($data->use_for =="Food")
                                <form method="post" id="add-coupon-form" action="{{url('owner/Coupon/'.$data->id)}}" autocomplete="off" enctype="multipart/form-data" >
                                @elseif($data->use_for =="Grocery")
                                <form method="post" id="add-coupon-form" action="{{url('owner/GroceryCoupon/'.$data->id)}}" autocomplete="off" enctype="multipart/form-data" >
                                @endif

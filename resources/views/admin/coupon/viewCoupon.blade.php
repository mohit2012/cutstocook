                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a href="{{url('owner/Coupon/create')}}" class="btn btn-sm btn-primary">{{ __('Add New Coupon') }}</a>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <td>                                                                        
                                                    <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                                <a class="dropdown-item" href="{{url('owner/Coupon/'.$coupon->code.'/edit')}}">{{ __('Edit') }}</a>
                                                                <a class="dropdown-item" onclick="deleteData('owner/Coupon','{{$coupon->id}}');" href="#">{{ __('Delete') }}</a>                                                             
                                                            </div>
                                                        </div>
                                                </td>
                                            </tr>

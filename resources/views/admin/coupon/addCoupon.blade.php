            ...
            <div class="row">
                    <div class="col-xl-12 order-xl-1">
                        <div class="card form-card bg-secondary shadow">
                            ...
                            <div class="card-body">
                                <form method="post" id="add-coupon-form" action="{{url('owner/Coupon')}}" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="row">
                                            <div class="col-2">
                                                <label class="form-control-label" for="input-description">{{ __('Coupon Type:') }}</label>
                                            </div>
                                            <div class="col-4">

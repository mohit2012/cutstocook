                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a href="{{url('owner/GroceryCoupon/create')}}" class="btn btn-sm btn-primary">{{ __('Add New Coupon') }}</a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge badge-dot mr-4">
                                                        ...
                                                        <span class="status">{{$coupon->status==0?'Active': 'Inactive'}}</span>
                                                    </span>
                                                </td>
                                                <td>                                                                        
                                                    <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                                <a class="dropdown-item" href="{{url('owner/GroceryCoupon/'.$coupon->code.'/edit')}}">{{ __('Edit') }}</a>
                                                                <a class="dropdown-item" onclick="deleteData('owner/GroceryCoupon','{{$coupon->id}}');" href="#">{{ __('Delete') }}</a>

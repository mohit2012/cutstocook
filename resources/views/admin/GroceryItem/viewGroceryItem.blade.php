                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a href="{{url('owner/GroceryItem/create')}}" class="btn btn-sm btn-primary">{{ __('Add New Item') }}</a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->shopName }}</td>
                                                <td><strike>{{$item->fake_price}}</strike>{{ $currency.$item->sell_price }}</td>
                                                <td>
                                                ...
                                                <td>                                                  
                                                    <div class="dropdown">
                                                        ...
                                                        u-right dropdown-menu-arrow">
                                                            ...
                                                            <a class="dropdown-item" href="{{url('owner/GroceryItem/'.$item->id.'/edit')}}">{{ __('Edit') }}</a>
                                                            <a class="dropdown-item" onclick="deleteData('owner/GroceryItem','{{$item->id}}');" href="#">{{ __('Delete') }}</a>                                                            
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>

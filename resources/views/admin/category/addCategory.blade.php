            ...
            <div class="row">
                    <div class="col-xl-12 order-xl-1">
                        <div class="card form-card bg-secondary shadow">
                            <div class="card-header bg-white border-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-4 text-right">
                                        <a href="{{ url('owner/Category') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            ...
                            <div class="card-body">
                                <form method="post" action="{{url('owner/Category')}}" autocomplete="off" enctype="multipart/form-data" >
                                    @csrf
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ url('owner/Category/importExcel') }}" method="post" enctype="multipart/form-data">
                @csrf

<html lang="en"><head>
    ...
    <p class="lead">
        <strong style="display:block;">Thanks for purchase Foodeli </strong>
        <br>
    ...
    <hr>
    <p class="lead">
    <a class="btn btn-primary btn-sm" href="{{url('/installer/install')}}" role="button">Foodeli Installer</a>
    </p>
    </div>
